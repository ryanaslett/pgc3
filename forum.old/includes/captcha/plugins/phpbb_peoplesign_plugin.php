...
*
* @package VC
* @version $Id: phpbb_peoplesign_plugin.php,v 1.0.13 2011/01/09 15:00 hookerb Exp$
...
class phpbb_peoplesign extends phpbb_default_captcha
{
	...
	var $peoplesign_wrapper_version	= "phpBB3_1.0.13";
	...
	**/
	function reset()
	{
		...
		$response = get_peoplesign_session_id(
			...
			$user->ip,
			$this->get_options_string(),
			$this->peoplesign_location,
			$this->peoplesign_wrapper_version,
