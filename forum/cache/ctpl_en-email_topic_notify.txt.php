...
You are receiving this notification because you are watching the topic, "<?php echo (isset($this->_rootref['TOPIC_TITLE'])) ? $this->_rootref['TOPIC_TITLE'] : ''; ?>" at "<?php echo (isset($this->_rootref['SITENAME'])) ? $this->_rootref['SITENAME'] : ''; ?>". This topic has received a reply<?php if ($this->_rootref['AUTHOR_NAME'] !== ('')) {  ?> by <?php echo (isset($this->_rootref['AUTHOR_NAME'])) ? $this->_rootref['AUTHOR_NAME'] : ''; } ?> since your last visit. You can use the following link to view the replies made, no more notifications will be sent until you visit the topic.
